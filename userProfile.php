...
<html lang="en">
  ...
  <body>
    <header>
      <div class="logo">RadarGas</div>
      <div class="pagemenu">
      <div class="pagelinks">
          <label class="pageselect" for="touch" id="labelpage">Voltar</label>
          <input type="checkbox" id="touch" onclick="window.location.href = './home.php'"/>
    ...
    <div class="container">
      <main class="content">
        ...
        <form class="form" id="form">
          <input type="hidden" value="true" name="userChange">
          <div class="input">
            <label for="nome">Nome </label>
            <input readonly type="text" id="nome" value="<?php echo $_SESSION["nome"]?>" name="nome"/>
          </div>
          <div class="input">
            <label for="email">Email </label>
            <input readonly type="text" id="email" value="<?php echo $_SESSION["email"]?>" name="email"/>
          </div>
          <div class="input">
            <label for="cpf">CPF </label>
            <input readonly type="number" id="cpf" oninput="limitarCPF(this)" value="<?php echo $_SESSION["cpf"]?>" name="cpf"/>
          </div>
        </form>
        <section class="btns">
          <button id="alter">Alterar dados</button>
          <button id="cancel" class="cancel" hidden>Cancelar</button>
      ...
      <div class="text">
        ...
        <form class="form" id="form2">
          <input type="hidden" value="true" name="passChange">
          <div class="input">
            <label for="senhaatual">Senha atual: </label>
            <input require type="text" id="senhaatual" name="senhaatual"/>
          </div>
          <div class="input">
            <label for="senhanova">Senha nova: </label>
            <input require type="password" id="senhanova" name="senhanova"/>
          </div>
          <div class="input">
            <label for="senhaconfirm">Confirme a senha nova: </label>
            <input require type="password" id="senhaconfirm" name="senhaconfirm"/>
          </div>
        </form>
        <section class="btns">
