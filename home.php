    ...
    <header>
      ...
      <div class="pagemenu">
        <div class="pagelinks">
          ...
          <label class="toggle" for="touch">
            <div id="bar1" class="bars"></div>
            <div id="bar2" class="bars"></div>
            <div id="bar3" class="bars"></div>
          </label>
          <label class="pageselect" for="touch" id="labelpage">Postos</label>
          <input type="checkbox" id="touch" />
          <ul class="dropdownmenu" id="pages">
            <li>Postos</li>
            <li>Bandeiras</li>
            <li>Combustiveis</li>
            <li>Usuários</li>
    ...
    <div class="container">
      ...
      <main class="content">
        ...
        <div class="filtermenu" id="filtermenu">
          ...
          <div class="register" style="flex-direction: row; gap: 25px;">
